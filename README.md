...
Blog posts live as individual JSON files under [content/blog/posts](content/blog/posts). The combined frontend feed [content/blog/posts.json](content/blog/posts.json), blog shell, and route files are generated by [scripts/build-blog.js](scripts/build-blog.js). The full posting guide is in [docs/blog-posting-guide.md](docs/blog-posting-guide.md).
